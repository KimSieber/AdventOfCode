...
### Lies Datei ein und gibt Puzzle zurück
...
### Fügt die Buchstaben aus verschiedenen Strings zusammen, jeder Buchstabe nur 1x, sortiert
def additionLetters(let1, let2):
    let = ''
    for l in let1:
        if l not in let:
            let += l
